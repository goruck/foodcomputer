...
This project describes how to use Amazon's Alexa to create a voice user interface to the [OpenAg Personal Food Computer (PFC)](https://www.media.mit.edu/groups/open-agriculture-openag/overview/) and provides a framework to use Alexa with the Internet of Things. 
